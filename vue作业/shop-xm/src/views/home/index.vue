						...
						<el-row :gutter="20">
							<el-col :span="12">
								<div class="grid-content bg-purple ">
									<div class="mc">商品总览</div>
									<div class="shuliang">
										<el-row :gutter="20">
										  <el-col :span="6"><div class="grid-content bg-purple">
										  <spam class="font-red">100</spam>
										  <br>
										  <spam>已下架</spam>
										  </div></el-col>
										  
										  <el-col :span="6"><div class="grid-content bg-purple">
										  <spam class="font-red">400</spam>
										  <br>
										  <spam>已上架</spam>
										  </div></el-col>
										  <el-col :span="6"><div class="grid-content bg-purple">
										  <spam class="font-red">50</spam>
										  <br>
										  <spam>库存紧张</spam>
										  </div></el-col>
										  <el-col :span="6"><div class="grid-content bg-purple">
										  <spam class="font-red">500</spam>
										  <br>
										  <spam>全部商品</spam>
										  </div></el-col>
										</el-row>
							...
							<el-col :span="12">
								<div class="grid-content bg-purple-light fenge">
									<div class="mc">用户总览</div>
									<div class="shuliang">
										<el-row :gutter="20">
										  <el-col :span="6"><div class="grid-content bg-purple">
										  <spam class="font-red">100</spam>
